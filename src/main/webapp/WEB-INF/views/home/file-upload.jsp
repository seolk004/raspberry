                   ...
                   <div class="card-body p-5">
				        ...
				        <div class="row justify-content-center">
					         <div class="mb-3">
						        ...
						        <button type="button" class="my-5 btn btn-primary" onClick="addFiles();">Add</button>						            
					         </div>
					         ...
					         <div class="mb-3">
					         	<button id="file-upload-btn" type="button" class="my-5 btn btn-primary" onClick="upload();">upload</button>
					         </div>
				        </div>
